-- @ehatt
-- utilities for handling folds in markdown. mostly used in @keymaps.lua
...
function fold_headings_of_level(level)
...
function fold_markdown_headings(levels)
